...
class DnsSettingView(APIView):
    ...
    def post(self):
        ...
        elif acme_dns_type_qy is not None and AcmeDns.query.(db.exists().where(and_(AcmeDns.user==user,AcmeDns.deleted_by.is_(None),AcmeDns.acme_dns_type_id==acme_dns_type_qy.id))).scalar():
